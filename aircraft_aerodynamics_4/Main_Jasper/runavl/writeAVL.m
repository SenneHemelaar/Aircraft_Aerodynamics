function writeAVL(avlfile, lw, cwr, lamw, epsr, epst, Lamw,...
                  phiw, Sref, cref, bref, Ncm, Nsm, Ncw, Nsw, winglet)
% Create AVL file
...
if winglet
    ...
    fprintf(fid, 'SECTION\n%f 14.0 0.0 %f %f 0 0\nCLAF\n1.0\n',...
            5.5-cwr, cwr, epsr);
    fprintf(fid, 'SECTION\n%f %f %f %f %f 0.0 0\nCLAF\n1.0\n',...
            5.5-cwr+lw*sin(Lamw), 14.0+lw*sin(phiw)*cos(Lamw), lw*cos(phiw)*cos(Lamw),...
            lamw*cwr, epst); %cos(Lamw) -> sin(Lamw) & sin(phiw) -> cos(Lamw)
end
fclose(fid);
end